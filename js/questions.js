let questions = [
 ...
 },
 {
   ...
   answer: [" je labilnejšia ako alkalická fosfatáza"],
   options: [
  " je labilnejšia ako alkalická fosfatáza", " tartrát-rezistentný izoenzým ACP je z osteoblastov", " tartrát-senzitívny enzým ACP je z osteoklastov", " patrí medzi cholestatické enzýmy"]
  },
  {
   numb: 81,
   question: " Aktivita ACP v sére býva zvýšená pri",
   answer: [" osteolytických metastázach do kosti"],
   options: [
  " osteogénnom sarkóme", " osteolytických metastázach do kosti", " nádoroch pecene", " nádoroch semenníkov"]
  },
  {
   numb: 82,
   question: " Prostatický izoenzým ACP",
   answer: [" je inhibovaný vínanom"],
   options: [
  " je termostabilný", " je inhibovaný leucínom", " je inhibovaný vínanom", " je induktívny enzým"]
  },
  {
   numb: 83,
   question: " Klinicky významné izoenzýmy má",
   answer: [" alkalická fosfatáza", " amyláza"],
   options: [
  " gama-glutamyltransferáza", " alkalická fosfatáza", " cholínesteráza", " amyláza"]
  },
  {
   numb: 84,
   question: " Klinicky významné izoenzýmy má",
   answer: [" kyslá fosfatáza", " laktátdehydrogenáza", " kreatínkináza"],
   options: [
  " kyslá fosfatáza", " lipáza", " laktátdehydrogenáza", " kreatínkináza"]
  },
  {
   numb: 85,
   question: " Alkalická fosfatáza",
   answer: [" má crevný izoenzým", " je membránovo-viazaný enzým"],
   options: [
  " má crevný izoenzým", " má svalový izoenzým", " je membránovo-viazaný enzým", " je cytosolový enzým"]
  },
  {
   numb: 86,
   question: " Alkalická fosfatáza",
   answer: [" má placentový izoenzým"],
   options: [
  " je mitochondriový enzým", " má placentový izoenzým", " má pankreatický izoenzým", " má erytrocytový izoenzým"]
  },
  {
   numb: 87,
   question: " Pre alkalickú fosfatázu platí",
   answer: [" crevná a placentová ALP sú izoenzýmy", " placentová ALP je termostabilná"],
   options: [
  " kostná a pecenová alkalická fosfatáza sú izoenzýmy", " crevná a placentová ALP sú izoenzýmy", " crevná a pecenová ALP sú izoformy"," placentová ALP je termostabilná"]
  },
  {
   numb: 88,
   question: " Pre alkalickú fosfatázu platí",
   answer: [" v sére zdravého dospelého cloveka je kostná a pecenová forma ALP v pomere 1:1"],
   options: [
  " v sére zdravého dospelého cloveka je kostná a pecenová forma ALP v pomere 1:1", " v sére detí je pomer medzi kostnou a pecenovou formou ALP menší ako 1", " hlavným izoenzýmom ALP v sére zdravého cloveka je crevný izoenzým", " hemolýza spôsobuje jej zvýšenie v sére"]
  },
  {
   numb: 89,
   question: " Alkalická fosfatáza",
   answer: [" je markerom osteoblastov", " býva zvýšená pri kostných ochoreniach", " pecenová ALP je izoforma tkanivovonešpecifického izoenzýmu"],
   options: [
  " je markerom osteoblastov", " je markerom osteoklastov", " býva zvýšená pri kostných ochoreniach", " pecenová ALP je izoforma tkanivovonešpecifického izoenzýmu"]
  },
  {
   numb: 90,
   question: " Alkalická fosfatáza",
   answer: [ " sa zvyšuje pri cholestáze"," býva zvýšená pri hyperparatyreóze"],
   options: [
  " sa zvyšuje pri cholestáze", " je markerom fibrogenézy", " zvyšuje sa pri hemolýze", " býva zvýšená pri hyperparatyreóze"]
  },
  {
   numb: 91,
   question: " Alkalická fosfatáza",
   answer: [" býva fyziologicky zvýšená v gravidite", " býva fyziologicky zvýšená u detí"],
   options: [
  " býva fyziologicky zvýšená v gravidite", " býva fyziologicky zvýšená u detí", " býva fyziologicky zvýšená u starých ludí", " má vysokú aktivitu v svalovom tkanive"]
  },
  {
   numb: 92,
   question: " Alkalická fosfatáza",
   answer: [" má vysokú aktivitu v peceni", " býva zvýšená pri postmenopauzálnej osteoporóze"],
   options: [
  " má vysokú aktivitu v erytrocytoch", " má vysokú aktivitu v peceni", " býva zvýšená pri postmenopauzálnej osteoporóze", " býva zvýšená pri senilnej osteoporóze"]
  },
  {
   numb: 93,
   question: " Izoenzýmy ALP",
   answer: [ " sú rozdielne inhibované fenylalanínom"," najcastejšie vyšetrujeme na základe ich rôznej tepelnej stability a pomocou inhibítorov"],
   options: [
  " sú rozdielne inhibované fenylalanínom", " sú rozdielne inhibované glutamátom", " najcastejšie stanovujeme elektroforeticky", " najcastejšie vyšetrujeme na základe ich rôznej tepelnej stability a pomocou inhibítorov"]
  },
  {
   numb: 94,
   question: " Izoenzýmy ALP",
   answer: [ " sa vyznacujú rozdielnou tepelnou stabilitou"," sú dôležité pre diagnózu osteoporózy"],
   options: [
  " sú pecenový a kostný", " sa vyznacujú rozdielnou tepelnou stabilitou", " sú rôzne inhibovatelné tartrátom (kys.vínnou)", " sú dôležité pre diagnózu osteoporózy"]
  },
  {
   numb: 95,
   question: " Izoenzýmy alkalickej fosfatázy možno vyšetrovat",
   answer: [ " na základe rozdielnej termostability", " imunochemicky", " pomocou lektínov"],
   options: [
  " na základe rozdielnej termostability", " na základe rozdielnej inhibovatelnosti tartrátom", " imunochemicky", " pomocou lektínov"]
  },
  {
   numb: 96,
   question: " Kreatínkináza",
   answer: [" signalizuje poškodenie myokardu", " nachádza sa hlavne v kostrovom svale"],
   options: [
  " býva zvýšená pri otrave organofosfátmin", " signalizuje poškodenie myokardu", " nachádza sa hlavne v kostrovom svale", " nachádza sa v skelete"]
  },
  {
   numb: 97,
   question: " Kreatínkináza",
   answer: [" nachádza sa v myokarde"],
   options: [
  " nachádza sa v myokarde", " býva zvýšená pri hemolýze", " býva zvýšená pri hepatobiliárnych ochoreniach", " signalizuje intravaskulárnu hemolýzu"]
  },
  {
   numb: 98,
   question: " Pre poškodenie myokardu svedcí okrem zvýšenej celkovej CK aj",
   answer: [" zvýšený izoenzým CK-MB"],
   options: [
  " zvýšená aktivita LD-5", " zvýšený izoenzým CK-MM", " zvýšený izoenzým CK-BB", " zvýšený izoenzým CK-MB"]
  },
  {
   numb: 99,
   question: " Pre poškodenie myokardu svedcí okrem zvýšenej celkovej CK aj",
   answer: [" zvýšená aktivita LD-1"," pomer CK/AST nižší ako 10"],
   options: [
  " zvýšená aktivita LD-1", " pomer CK/AST vyššíí ako 10", " zvýšená aktivita ALP", " pomer CK/AST nižší ako 10"]
  },
  {
   numb: 100,
   question: " Zvýšená aktivita CK v sére môže byt spôsobená",
   answer: [" myopatiou", " zvýšenou fyzickou námahou"],
   options: [
  " osteolýzou", " osteoporózou", " myopatiou", " zvýšenou fyzickou námahou"]
  },
  {
   numb: 101,
   question: " Zvýšená aktivita CK v sére môže byt spôsobená",
   answer: [" poškodením myokardu", " poškodením kostrového svalu", " myozitídou"],
   options: [
  " hepatitídou typu B", " poškodením myokardu", " poškodením kostrového svalu", " myozitídou"]
  },
  {
   numb: 102,
   question: " Pre izoenzýmy CK platí",
   answer: [" poznáme tri izoenzýmy CK"],
   options: [
  " podiel CK-MB v myokarde je okolo 60%", " aktivita CK-BB sa zvyšuje pri pecenových ochoreniach", " poznáme dva izoenzýmy CK", " poznáme tri izoenzýmy CK"]
  },
  {
   numb: 103,
   question: " Pre izoenzýmy CK platí",
  ...
  },
  {
   ...
   answer: [],
   options: [
  " CK/AST", " LD-1/LD-2", " LD-5/ALT", " ALP/ACP"]
  },
  {
   numb: 120,
   question: " Pri ochoreniach pecene sa používa vyšetrenie pomeru",
  ...
  },
  {
   ...
   answer: [],
   options: [
  " albumín", " haptoglobín", " ceruloplazmín", " transferín"]
  },
  {
   numb: 144,
   question: " Vo frakcii alfa-1-globulínov nachádzame",
  ...
  },
  {
   ...
   answer: [],
   options: [
  " Waldenstromovou makroglobulinémiou", " chorobou tažkých retazcov", " s imunodeficienciou", " pri hladovaní"]
  },
  {
   numb: 149,
  ...
  },
  {
   ...
   answer: [],
   options: [
  " pacientovi podávame 100 g glukózy", " pacientovi podávame 2 g glukózy na kg telesnej hmostnosti", " detom podávame 2 g glukózy na kg telesnej hmostnosti", " detom podávame glukózu podla veku"]
  },
  {
   numb: 185,
   question: " Orálny glukózový tolerancný test",
  ...
  },
  {
   ...
   answer: [],
   options: [
  " rozhodujúca je glykémia po 1.hodine", " pri diabete je glykémia po 2 hodinách v rozmedzí 9-11 mmol/l", " pre diagnózu diabetu má pacient po 1.hodine glykémiu menej ako 11 mmol/l", " glykémia po 2 hodinách vyššia ako 7 mmol/l svedcí pre diabetes"]
  },
  {
   numb: 187,
   question: " Pri vyhodnotení oGTT",
  ...
  },
  {
   ...
   answer: [],
   options: [
  " v moci", " v žaludocnej štave", " po stimulácii pentagastrínom", " po stimulácii histamínom"]
  },
  {
   numb: 234,
  ...
  },
  {
   ...
   answer: [],
   options: [
  " pentagastrínový test", " ceruleínový test", " MEGX-test", " sekretín-pankreozymínový test"]
  },
  {
   numb: 305,
  ...
  },
  {
   ...
   answer: [],
   options: [
  " vírusovú hepatitídu C", " primárnu sklerozujúcu cholangitídu", " autoimúnnu hepatitídu", " alkohol-toxickú hepatitídu"]
  },
  {
   numb: 310,
   question: " Prítomnost antimitochondriálnych protilátok je charakteristická pre",
  ...
  },
  {
   ...
   answer: [],
   options: [
  " ALP", " test s ceruleínom", " alfa-fetoproteínu", " alfa-1-antitrypsínu"]
  },
  {
   numb: 323,
  ...
  },
  {
   ...
   answer: [],
   options: [
  " zvýšenú aktivitu cholínesterázy", " zvýšenú hladinu albumínu v sére", " zníženú aktivitu AST", " pozitívny HBsAg"]
  },
  {
   numb: 332,
   question: " Pri akútnej hepatitíde typu A nachádzame",
  ...
  },
  {
   ...
   answer: [],
   options: [
  " proteinúriou menej ako 1 g/l", " proteinúriou 1-5 g/l", " nálezom erytrocytových valcov", " leukocytúriou"]
  },
  {
   numb: 358,
   question: " Nefrotický syndróm je charakterizovaný",
  ...
  },
  {
   ...
   answer: [],
   options: [
  " sekundárnu hypotyreózu", " primárnu hypotyreózu", " subklinickú hypertyreózu", " subklinickú hypotyreózu"]
  },
  {
   numb: 451,
   question: "U pacienta sme zistili zvýšenú hodnotu fT4 a normálnu hodnotu TSH. Môže íst o",
  ...
  },
  {
   ...
   answer: [],
   options: [
  " sa používa na rozlíšenie primárnej a sekundárnej hyperfunkcie kôry nadoblicky", " sa používa na rozlíšenie primárnej a sekundárnej hypofunkcie kôry nadoblicky", " pomer ACTH v krvi splavov a laktovej krvi viac ako 3:1 svedcí o Cushingovom syndróme", " pomer ACTH v krvi splavov a laktovej krvi menej ako 3:1 svedcí o Cushingovom syndróme"]
  },
  {
   numb: 493,
  ...
  },
  {
   ...
   answer: [],
   options: [
  " môže byt u pacientov s abetalipoproteinémiou", " máva zvýšenú hladinu HDL-cholesterolu", " je spojená s rizikom akútnej pankreatitídy", " je najcastejším typom hyperlipoproteinémie u nás"]
  },
  {
   numb: 560,
  ...
  {
   numb: 586,
   question: " Vypocítajte frakcnú exkréciu vápnika u pacienta u ktorého boli namerané nasledovné",
   answer: [],
   options: [
  "   0,95%", "   0,84%", " 1,03%", "   2,75%"]
  },
  {
   numb: 587,
   question: " Pri laboratórnom vyšetrení boli zistené nasledovné hodnoty:",
   answer: [],
   options: [
  "   99,12%", "   97,28%", "       95,85%", "   62,38%"]
  },
  {
   numb: 588,
   question: " Pri laboratórnom vyšetrení boli zistené nasledovné hodnoty:",
   answer: [],
   options: [
  " 2,06 ml/s", " 1,79 ml/s", " 1,25 ml/s", " 0,85 ml/s"]
  },
  {
   numb: 589,
   question: " Pri laboratórnom vyšetrení boli zistené nasledovné hodnoty:",
   answer: [],
   options: [
  " 0,80 ml/s", " 1,2 ml/s", " 72 ml/min", " 48 ml/min"]
  },
  {
   numb: 590,
   question: " Pri laboratórnom vyšetrení boli zistené nasledovné hodnoty:",
  ...
  {
   numb: 592,
   question: " Pri vyšetrení ABR boli zistené nasledovné hodnoty:",
   answer: [],
   options: [
  " akútna metabolická alkalóza", " chronická respiracná acidóza", " chronická metabolická acidóza", " MAC + MAL"]
  },
  {
   numb: 593,
   question: " Pri vyšetrení ABR boli namerané nasledovné hodnoty: pH = 7,48      pCO2 = 5,7 kPa  HCO3 = 31 mmol/l O aký typ poruchy ABR sa u pacienta jedná?",
   answer: [],
   options: [
  " akútna respiracná alkalóza", " akútna metabolická alkalóza", " RAC + MAL", " chronická respiracná alkalóza"]
  },
  {
   numb: 594,
   question: " Pri vyšetrení vnútorného prostredia boli zistené nasledovné hodnoty:",
   answer: [],
   options: [
  " akútna metabolická alkalóza", " MAC + MAL", " chronická respiracná alkalóza", " akútna respiracná alkalóza"]
  },
  {
   numb: 595,
   question: " Pri vyšetrení ABR boli namerané nasledovné hodnoty:",
   answer: [],
   options: [
  " chronická RAC", " akútna RAC", " MAC + RAC", " chronická MAC"]
  },
  {
   numb: 596,
   question: " Pri vyšetrení ABR boli zistené nasledovné hodnoty: pH = 7,28    pCO2 = 4,7 kPa         HCO3 = 16 mmol/l O aký typ poruchy ABR sa jedná",
   answer: [],
   options: [
  " akútna RAC", " akútna MAC", " ciastocne kompenzovaná MAC", " ciastocne kompenzovaná RAC"]
  },
  {
   numb: 597,
   question: " Pri vyšetrení ABR boli namerané nasledovné hodnoty: pH = 7,51      pCO2 = 4,5 kPa  HCO3 = 26 mmol/l O aký typ poruchy sa u pacienta jedná?",
   answer: [],
   options: [
  " akútna MAL", " chronická RAC", " RAL + MAL", " RAL + MAC"]
  },
  {
   numb: 598,
   question: " Pri vyšetrení ABR boli namerané nasledovné hodnoty:",
   answer: [],
   options: [
  " chronická MAC", " chronická RAC", " MAC + MAL", " MAC + RAL"]
  },
  {
   numb: 599,
   question: " Pri vyšetrení ABR boli namerané nasledovné hodnoty:",
   answer: [],
   options: [
  " chronická RAC", " neúplne kompenzovaná MAC", " RAC + MAL", " MAC + RAC"]
  },
  {
   numb: 600,
   question: " Pri vyšetrení vnútorného prostredia boli zistené nasledovné hodnoty:",
   answer: [],
   options: [
  " kompenzovaná MAL", " kompenzovaná RAC", " fyziologický nález", " RAL + MAC"]
  },
  {
   numb: 601,
   question: " Pri vyšetrení vnútorného prostredia boli zistené nasledovné hodnoty:",
   answer: [],
   options: [
  " kompenzovaná MAC", " chronická RAL", " MAC + RAL", " MAC + RAC"]
  },
  {
   numb: 602,
   question: " Pri vyšetrení vnútorného prostredia boli zistené nasledovné hodnoty: pH = 7,25     pCO2 = 5,1 kPa  HCO3 = 16 mmol/l        BE = -10 mmol/l O aký typ poruchy ABR sa u pacientky jedná?",
   answer: [],
   options: [
  " MAC + RAC", " akútna RAC", " chronická MAC", " akútna MAC"]
  },
];
